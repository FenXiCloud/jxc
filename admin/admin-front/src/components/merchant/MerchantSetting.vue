...
import OrganizationList from "@components/merchant/organization/OrganizationList";

export default {
  name: "MerchantSetting",
  components: {MerchantModuleGrant, AdminList, RoleList,OrganizationList},
  props: {
    merchant: Object
  },
  emits: {
