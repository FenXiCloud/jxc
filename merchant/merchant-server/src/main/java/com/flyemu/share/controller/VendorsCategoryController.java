...
public class VendorsCategoryController {
    ...
    public JsonResult delete(@PathVariable Integer vendorsCategoryId, @SaMerchantId Integer merchantId) {
        vendorsCategoryService.delete(vendorsCategoryId, merchantId);
        return JsonResult.successful();
    }
