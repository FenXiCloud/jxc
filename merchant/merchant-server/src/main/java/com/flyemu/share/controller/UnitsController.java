...
public class UnitsController {
    ...
    public JsonResult delete(@PathVariable Integer unitsId, @SaMerchantId Integer merchantId) {

        unitsService.delete(unitsId, merchantId);
        return JsonResult.successful();
    }

    @GetMapping("select")
    public JsonResult select(@SaMerchantId Integer merchantId) {
        return JsonResult.successful(unitsService.select(merchantId));
    }
}
