...
const groupRoutes = [
	...
	{name: 'RelationCw', component: defineAsyncComponent(() => import('@components/group/setting/RelationCw.vue'))},
	{name: 'OrderVoucher', component: defineAsyncComponent(() => import('@components/group/setting/RelationOrderVoucher.vue'))},
