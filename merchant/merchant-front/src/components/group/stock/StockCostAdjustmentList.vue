  ...
  <div class="frame-page flex flex-column">
    ...
    <div class="flex1">
      <vxe-table row-id="id"
        ...
        <vxe-column title="仓库" field="warehousesName" width="120"></vxe-column>
        ...
        <vxe-column title="操作" align="center" width="200">
          <template #default="{row}">
            <span class="primary-color  text-hover ml-10px" @click="toAdjustment(row.productsId,row.warehouseId)">成本调整</span>
          </template>
        </vxe-column>
      </vxe-table>
    </div>
