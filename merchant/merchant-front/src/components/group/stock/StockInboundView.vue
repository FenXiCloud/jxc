    ...
    <div class="modal-column-full-body">
      ...
      <div class="pt-13px">
        <vxe-table
          ...
          <vxe-column title="入库数量" field="orderQuantity" align="center" width="80"/>
          <vxe-column title="入库单价" field="orderPrice" width="80"/>
      ...
      <vxe-toolbar class-name="before-table">
        <template #tools>
          <div class="text-14px">
            <span class="ml-5px">合计入库金额： ¥<span class="red-color">{{ order.discountedAmount || 0 }}</span></span>
          </div>
        </template>
      </vxe-toolbar>
